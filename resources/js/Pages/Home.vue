...
const services = [
    ...
    { num: '03', slug: 'danocen-konsalting', name: 'Даночен консалтинг', desc: 'Усогласеност со законот и оптимизација на даноците.' },
    { num: '04', slug: 'registracija-firma', name: 'Регистрација на фирма', desc: 'Брзо основање — ДООЕЛ, СВД, ФЛ — без непотребно чекање.' },
    { num: '05', slug: 'presmetka-na-plati', name: 'Пресметка на плати', desc: 'Плати, придонеси и пријавување кај УЈП — уредно секој месец.' },
    ...
    { num: '07', slug: 'konsalting-za-msp', name: 'Консалтинг за МСП', desc: 'Стратешки финансиски совети прилагодени за твојот бизнис.' },
    { num: '08', slug: 'danocna-optimizacija', name: 'Даночна оптимизација', desc: 'Легални начини за намалување на даночниот товар.' },
]
