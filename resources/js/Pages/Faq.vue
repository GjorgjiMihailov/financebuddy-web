...
const categories = [
    {
        ...
        items: [
            ...
            },
            {
                ...
                a: 'Фриленсерот физичко лице плаќа 10% персонален данок на доход плус задолжителни придонеси за ПИО и здравство. Точниот износ на придонеси зависи од месечната основица. Контактирајте нè за точна пресметка според вашата конкретна ситуација.',
            },
            {
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                a: 'Во Македонија не постои законски минимален основачки капитал за ДООЕЛ — може да биде и 1 денар. Во практика, препорачуваме основниот капитал да одговара на реалните потреби на бизнисот.',
            },
            {
        ...
        items: [
            {
                ...
                a: 'Годишната сметка за претходната деловна година мора да се поднесе до Централен регистар (ЦРРСМ) најдоцна до 28 февруари. Задоцнетото поднесување повлекува казни.',
            },
            {
            ...
            },
            {
                ...
                a: 'Да — ако управителот активно работи во друштвото, мора да биде пријавен во Агенцијата за вработување и да му се плаќаат придонеси за ПИО и здравствено осигурување. Непријавувањето е прекршок со законски санкции.',
            },
        ],
    },
]
...
<template>
    <Head>
        <title>FAQ — Честопоставувани прашања | FinanceBuddy.mk</title>
